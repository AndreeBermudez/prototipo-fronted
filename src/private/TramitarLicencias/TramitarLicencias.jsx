          ...
          <table className="w-full border border-none text-xs sm:text-sm">
            <thead className="bg-[#F9FAFB]">
              <tr className="font-semibold">
                ...
                <th className="border-b border-gray-300 p-2 whitespace-nowrap">RUC</th>
            ...
            <tbody>
              <tr>
                ...
                <td className="border-b border-gray-300 text-center p-2 whitespace-nowrap">10745623876</td>
              ...
              <tr>
                ...
                <td className="border-b border-gray-300 text-center p-2 whitespace-nowrap">10855623878</td>
                <td className="border-b border-gray-300 text-center p-2 whitespace-nowrap">
                  <div className="flex justify-center items-center">
