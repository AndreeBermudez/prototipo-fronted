...
export const RegistrarCodigo = () => {
  ...
  return (
    <section className='max-w-7xl w-full bg-white px-10 py-5 rounded-lg shadow-md flex flex-col gap-5'>
        ...
        <table className='min-w-full border border-none text-sm'>
          <thead className='bg-[#F9FAFB]'>
            <tr className='font-semibold'>
              <th className='border-b border-gray-300 p-2 whitespace-nowrap'>Código</th> {/* Añadido whitespace-nowrap */}
              ...
              <th className='border-b border-gray-300 p-2 whitespace-nowrap'>Usado</th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td className='border-b border-gray-300 text-center p-2 whitespace-nowrap'>12345678901234567890</td> {/* Añadido whitespace-nowrap */}
            ...
            <tr>
              <td className='border-b border-gray-300 text-center p-2 whitespace-nowrap'>12345678901234567890</td>
              <td className='border-b border-gray-300 text-center p-2 whitespace-nowrap'>
                12/12/2021
              </td>
              <td className='border-b border-gray-300 text-center p-2 whitespace-nowrap'>Usado</td>
              <td className='border-b border-gray-300 text-center p-2 whitespace-nowrap flex justify-center'>
                <Check />
              </td>
            </tr>
